...
class ConstructorAssertionErrorTest {
    ...
    void Should_Return_Expected_Detailed_Message_Without_Parameters() throws NoSuchMethodException {
        ...
        final String expectedMessage =
                "Constructor:\n" +
                        "private com.java.pojo.internal.assertion.constructor.ConstructorAssertionErrorTest$Pojo()\n" +
                        "of class:\n" +
                        "class com.java.pojo.internal.assertion.constructor.ConstructorAssertionErrorTest$Pojo\n" +
    ...
    void Should_Return_Expected_Error_Prefix() throws NoSuchMethodException {
        // given
        final String expectedMessage = "Class com.java.pojo.internal.assertion.constructor" +
