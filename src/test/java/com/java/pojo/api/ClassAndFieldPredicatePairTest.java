...
class ClassAndFieldPredicatePairTest {
    ...
    @Test
    void Should_Create_Predicate_That_Accepts_All_Fields_By_Class_Name() throws ClassNotFoundException {
        // given
    ...
    @Test
    void Should_Create_Predicate_That_Accepts_Given_Fields_By_Class_Name() throws ClassNotFoundException {
        // given
        final Class<?> expectedClass = GoodPojo_Equals_HashCode_ToString.class;
        final String[] expectedFields = new String[]{"random",
                "byteField",
