...
public class ClassAndFieldPredicatePair {
     ...
     */
    public ClassAndFieldPredicatePair(final String qualifiedClassName, final Predicate<String> fieldsPredicate) throws ClassNotFoundException {
        this(Thread.currentThread().getContextClassLoader().loadClass(qualifiedClassName), fieldsPredicate);
    }
     ...
     * @throws ClassNotFoundException 
     */
    public ClassAndFieldPredicatePair(final String qualifiedClassName) throws ClassNotFoundException {
    	this(Thread.currentThread().getContextClassLoader().loadClass(qualifiedClassName));
    }
